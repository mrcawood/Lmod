local base        = "/Users/mcawood/Lmod/Lmod/settarg"
local settarg_cmd = pathJoin(base, "settarg_cmd.in.lua")
...
local exitCmd = "eval `" .. "/opt/homebrew/bin/lua " .. settarg_cmd .. " -s " .. myShell .. " --destroy`"
